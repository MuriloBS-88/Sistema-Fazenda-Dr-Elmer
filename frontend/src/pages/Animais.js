          ...
          <Dialog open={dialogBulkOpen} onOpenChange={(open) => { setDialogBulkOpen(open); if (!open) resetBulkForm(); }}>
            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto" data-testid="bulk-animal-dialog">
              ...
              <form onSubmit={handleBulkSubmit} className="space-y-4">
                ...
                <div><Label>Data de Nascimento</Label><Input type="date" value={formBulk.data_nascimento} onChange={(e) => setFormBulk({...formBulk, data_nascimento: e.target.value})} /></div>
                <div><Label>Peso Atual (kg)</Label><Input type="number" step="0.01" value={formBulk.peso_atual} onChange={(e) => setFormBulk({...formBulk, peso_atual: e.target.value})} /></div>
